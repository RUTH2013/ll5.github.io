...
> 由于该项目后端有我一个人完成,并且是我第一个 Go 的项目,所以碰到的问题还是比较多的,除了基础语法和技巧外,这个项目还碰到过几个印象比较深刻的问题,1.图形验证码问题,试了好几种图形验证码,最终觉得还是[dchest/captcha](https://github.com/dchest/captcha) 最好用,其他的多多少少都有一点点坑.而 dchest/captcha其实我感觉应该再多一个生成 base64 字符串的 api , 我把项目克隆下来实现了并提交pr,不过被作者拒绝了。
